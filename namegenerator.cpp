...
QString NameGenerator::run(CH_RACE chRace, CH_CLASS chClass) {
...
QString NameGenerator::generateName(bool withPrefix, bool withSuffix, bool withPostfix)
{
...
QString NameGenerator::generateSurname(bool withPrefix, bool withSuffix, bool withPostfix)
{
...
QString NameGenerator::generateTitle(QString event, QString base)
{
